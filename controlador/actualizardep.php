...
<head>
    ...
    <title>Talent Hunter|Editar Deportista</title>
    	...
    	<div class="row mt-3 mx-2 justify-content-center">
			...
			<div class="row pt-3">
				...
				$row=$resultado->fetch_assoc(); ?>
          		...
          		<form method="post" action="..\modelo\ejecutaactualizardep.php" enctype="multipart/form-data">
        	...
        	<div class="row">
          		...
          		<div class="col-lg-4 my-1">
					...
					<input type="text" class="form-control" name="position" required placeholder="Ingresa la posicion" pattern="[A-Za-zzÑñÁÉÍÓÚáéíóú\s]+"value="<?php echo $row['position'];?>" />
          		</div>
